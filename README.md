...
* **flexible** - supports a variety of data storage options, and works on lots of different server types (including the new **SKVs** platform).
...
[`README_SKVS.md`](https://github.com/Titanius69/LuckPerms-skvs/blob/master/README_SKVS.md)
...
* **Bukkit, BungeeCord, Fabric, Forge, Nukkit, Sponge, Velocity & SKVs** - Each use the common module to implement plugins on the respective server platforms.
